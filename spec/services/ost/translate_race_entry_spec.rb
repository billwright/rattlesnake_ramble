...
RSpec.describe OST::TranslateRaceEntry do
  describe '.perform' do
    ...
    it 'translates a race_entry (with associated racer) into an OST-compatible attribute set' do
      ...
      expect(translation).to eq({gender: 'male', first_name: 'Johnny', last_name: 'Appleseed', birthdate: Date.parse('1999-10-01'), city: 'Boulder', state_code: 'CO', email: 'johnny@appleseed.com', bib_number: 123})
    end
  end
end
